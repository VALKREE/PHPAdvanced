<?php
	...
	class class_User extends class_Base {
		...
		public function action_info() {
			...
			$this->content = $this->Template('views/user_info.php', array('username' => $user_info['name'], 'userlogin' => $user_info['login']));
		}
		
		public function action_reg() {
			
			$this->title .= '::Регистрация';
			$this->content = $this->Template('views/user_reg.php', array());
		...
		public function action_login() {
			$this->title .= '::Вход';
			$this->content = $this->Template('views/user_login.php', array());
